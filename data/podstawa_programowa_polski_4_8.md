# Podstawa programowa — Język polski — Szkoła podstawowa kl. IV-VIII
## Źródło: Rozporządzenie MEN z 28 czerwca 2024 r. (Dz.U. 2024 poz. 996)
...
- Znajomość wybranych dzieł polskich i światowych z umiejętnością ich omawiania
- Kształtowanie uczestnictwa w kulturze polskiej i europejskiej
- Rozwijanie zdolności dostrzegania wartości: prawdy, dobra, piękna, szacunku dla człowieka
- Szacunek dla przeszłości jako podstawy tożsamości
- Zainteresowanie kulturą lokalną

### II. Kształcenie językowe
- Rozwijanie rozumienia wartości języka ojczystego oraz jego funkcji w budowaniu tożsamości
- Twórczy i sprawczy charakter działań językowych
- Poznawanie pojęć opisujących język
...
- Wiedza o elementach wypowiedzi

### III. Tworzenie wypowiedzi
- Umiejętności wypowiadania się w określonych formach
...
- Rzetelne korzystanie ze źródeł wiedzy, stosowanie cudzysłowu
- Nawyki systematycznego uczenia się

---

## TREŚCI NAUCZANIA — KL. IV-VI (wymagania szczegółowe)
...
- Wyrażania własne rozumienie utworu i uzasadnia je
...
### III. Tworzenie wypowiedzi
Uczeń:
- Tworzy wypowiedzi: dialog, opowiadanie, opis, list, sprawozdanie, dedykacja, zaproszenie, podziękowanie, ogłoszenie, życzenia, charakterystyka, tekst argumentacyjny
- Wygłasza z pamięci ze zrozumieniem i odpowiednią intonacją
- Tworzy plany odtwórcze i twórcze
- Rozróżnia argumenty faktyczne od emocjonalnych

---

## TREŚCI NAUCZANIA — KL. VII-VIII (wymagania dodatkowe)
...
### III. Tworzenie wypowiedzi
Uczeń:
- Tworzy: recenzja, rozprawka, podanie, CV, list motywacyjny, przemówienie, wywiad
- Streszcza i parafrazuje
- Wykorzystuje tezy, hipotezy i argumenty
- Odróżnia przykład od argumentu
- Przeprowadza wnioskowanie, polemizuje z poglądami
...
1. Wychowywanie świadomego odbiorcy i uczestnika kultury
2. Rozwijanie poczucia tożsamości narodowej i szacunku dla tradycji
3. Rozwijanie umiejętności komunikowania się w różnych sytuacjach
4. Rozwijanie umiejętności formułowania myśli, operowania bogatym słownictwem
5. Kształcenie umiejętności posługiwania się gatunkami wypowiedzi ustnej i pisemnej
6. Kształtowanie samodzielności w docieraniu do informacji i selekcjonowaniu ich
7. Integracja kształcenia literackiego, językowego i kulturowego
8. Stosowanie metod: dyskusja, debata, drama, projekt edukacyjny
9. Uwzględnianie różnych potrzeb uczniów (różnicowanie)
