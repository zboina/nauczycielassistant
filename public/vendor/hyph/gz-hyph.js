/* Hypher (algorytm Knutha-Liang) + polskie wzorce TeX.
   Wynik: window.GzHyphenator = nowy Hypher(polish). */
(function (global) {
    var module = {};
    /* === HYPHER (lib/hypher.js) === */
/**
 * @constructor
...
module.exports = Hypher;
    var Hypher = module.exports;
    /* === POLISH PATTERNS (hyphenation.pl/lib/pl.js) === */
    module = {};
module.exports = {
	'id': 'pl',
	'leftmin': 2,
    ...
    var polish = module.exports;
    global.GzHyphenator = new Hypher(polish);
